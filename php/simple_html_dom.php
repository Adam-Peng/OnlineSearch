 ...
 * Acknowledge: Jose Solorzano (https://sourceforge.net/projects/e-html/)
 * Contributions by:
...
class simple_html_dom_node
{
    ...
    protected function parse_selector($selector_string) {
        ...
        // Note: if you try to look at this attribute, yo MUST use getAttribute since $dom->x:y will fail the e syntax check.
...
class simple_html_dom
{
    ...
    protected function parse_charset()
    {
        ...
        if (empty($charset))
        {
            // Have e try to detect the encoding from the text given to us.
